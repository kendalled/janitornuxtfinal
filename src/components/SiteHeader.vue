    ...
    <nav class="sm:flex sm:items-center sm:px-4 xl:flex-1 xl:justify-between" :class="{ 'hidden': !isOpen, 'block': isOpen }">
      ...
      <div class="sm:flex sm:items-center">
        <div class="navitems px-2 pt-2 pb-5 border-b border-gray-800 sm:flex sm:border-b-0 sm:py-0 sm:px-0">
          <nuxt-link to="/" class="xl:text-sm tracking-tight block font-semibold px-3 py-1 rounded text-gray-600 transition-colors hover:text-blue-600 hover:text-white sm:text-sm sm:px-2 xl:text-gray-800">
            Services
          </nuxt-link>
          <nuxt-link to="/" class="xl:text-sm tracking-tight block font-semibold px-3 py-1 rounded text-gray-600 transition-colors hover:text-blue-600 hover:text-white sm:text-sm sm:px-2 xl:text-gray-800">
            Our Work
        ...
        <div class="relative px-5 py-5 sm:py-0 sm:ml-4 sm:px-0">
          <div class="flex items-center sm:hidden">
            <!-- mobile ul -->
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon-user px-1 h-8 w-8 object-cover rounded-full border-2 border-gray-600 text-blue-600 fill-current"><path class="primary" d="M12 12a5 5 0 1 1 0-10 5 5 0 0 1 0 10z" /><path class="secondary" d="M21 20v-1a5 5 0 0 0-5-5H8a5 5 0 0 0-5 5v1c0 1.1.9 2 2 2h14a2 2 0 0 0 2-2z" /></svg>
          ...
          <div class="mt-5 sm:hidden">
            ...
            <a href="#support" class="mt-3 block text-gray-600 transition-colors xs:hover:text-blue-600 xs:hover:text-white">Support</a>
            <nuxt-link to="login" class="mt-3 block text-gray-600 transition-colors xs:hover:text-blue-600 xs:hover:text-white">
              Sign In
            </nuxt-link>
          </div>
          <Dropdown class="hidden sm:block">
            <template #trigger="{ hasFocus, isOpen }">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon-user fill-current text-blue-600 h-full w-full object-cover"><path class="primary" d="M12 12a5 5 0 1 1 0-10 5 5 0 0 1 0 10z" /><path class="secondary" d="M21 20v-1a5 5 0 0 0-5-5H8a5 5 0 0 0-5 5v1c0 1.1.9 2 2 2h14a2 2 0 0 0 2-2z" /></svg>
            ...
            <template #dropdown>
              <div class="mt-3 bg-white xl:border rounded-lg w-48 py-2 shadow-xl">
                ...
                <a href="#support" class="block hover:text-white text-gray-800 mt-0 px-4 py-2 hover:bg-blue-500">Support</a>
                <nuxt-link to="login" class="block hover:text-white text-gray-800 mt-0 px-4 py-2 hover:bg-blue-500">
                  Sign In
                </nuxt-link>
              </div>
            </template>
