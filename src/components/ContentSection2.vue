<template>
  <div class="px-16 pt-4 pb-12 bg-gray-200 border-t-4 border-blue-600">
    <h1 class="text-3xl mt-12 text-blue-700 font-bold text-center px-10">
      Get started with the facts.
    </h1>

    <h2 class="text-lg mb-8 mt-2 px-10 text-center text-gray-600">
      From rug use-cases to support info, read about our services below.
    </h2>

    <ul class="flex flex-wrap">
      <li class="w-full sm:w-1/2 flex flex-col">
        <div class="flex flex-col h-full bg-gray-100 rounded border-2 m-6 py-6 px-8">
          ...
          <button class="bg-blue-500 rounded transition-colors hover:bg-blue-700 text-gray-100 font-bold py-2 px-4 rounded w-full mt-6">
            Learn More
          </button>
        </div>
      </li>
